...
# source: ict/protobuf/backend/db.proto
...
from ict.protobuf.backend import simulation_pb2 as ict_dot_protobuf_dot_backend_dot_simulation__pb2


DESCRIPTOR = _descriptor.FileDescriptor(
  name='ict/protobuf/backend/db.proto',
  package='backend.db',
  syntax='proto3',
  serialized_pb=_b('\n\x1dict/protobuf/backend/db.proto\x12\nbackend.db\x1a%ict/protobuf/backend/simulation.proto\"a\n\x0c\x44\x61taRequired\x12\n\n\x02id\x18\x01 \x01(\t\x12\x11\n\tnode_name\x18\x02 \x01(\t\x12\x32\n\x05\x62lock\x18\x03 \x01(\x0e\x32#.backend.simulation.SimulationBlock\"s\n\rHeatPump1Info\x12\n\n\x02id\x18\x01 \x01(\t\x12\x11\n\tt_in_cold\x18\x02 \x01(\x02\x12\x10\n\x08t_in_hot\x18\x03 \x01(\x02\x12\r\n\x05t_set\x18\x04 \x01(\x02\x12\x10\n\x08mflow_hs\x18\x05 \x01(\x02\x12\x10\n\x08mflow_cs\x18\x06 \x01(\x02\"\x84\x01\n\rHeatPump2Info\x12\n\n\x02id\x18\x01 \x01(\t\x12\x11\n\tt_in_cold\x18\x02 \x01(\x02\x12\x10\n\x08t_in_hot\x18\x03 \x01(\x02\x12\x0e\n\x06t_heat\x18\x04 \x01(\x02\x12\x0e\n\x06p_heat\x18\x05 \x01(\x02\x12\x10\n\x08mflow_hs\x18\x06 \x01(\x02\x12\x10\n\x08mflow_cs\x18\x07 \x01(\x02\"\xd3\x01\n\x12ThermalNetworkInfo\x12\n\n\x02id\x18\x01 \x01(\t\x12\x12\n\nt_ret_cool\x18\x02 \x01(\x02\x12\x12\n\nt_ret_heat\x18\x03 \x01(\x02\x12\r\n\x05t_ret\x18\x04 \x01(\x02\x12\r\n\x05t_sup\x18\x05 \x01(\x02\x12\x12\n\nt_sup_cool\x18\x06 \x01(\x02\x12\x12\n\nt_sup_heat\x18\x07 \x01(\x02\x12\x15\n\rmflow_central\x18\x08 \x01(\x02\x12\x15\n\rmflow_heating\x18\t \x01(\x02\x12\x15\n\rmflow_cooling\x18\n \x01(\x02\"\x1e\n\x10PowerNetworkInfo\x12\n\n\x02id\x18\x01 \x01(\t\"8\n\x0c\x43onsumerInfo\x12\n\n\x02id\x18\x01 \x01(\t\x12\x0e\n\x06values\x18\x02 \x03(\x02\x12\x0c\n\x04t_up\x18\x03 \x01(\x02\"z\n\tStoreData\x12\x15\n\rsimulation_id\x18\x01 \x01(\t\x12\x0f\n\x07node_id\x18\x02 \x01(\t\x12\x16\n\x0e\x61ttribute_name\x18\x03 \x01(\t\x12\x10\n\x08timestep\x18\x04 \x01(\x02\x12\r\n\x05value\x18\x05 \x01(\x02\x12\x0c\n\x04unit\x18\x06 \x01(\tb\x06proto3')
  ,
  dependencies=[ict_dot_protobuf_dot_backend_dot_simulation__pb2.DESCRIPTOR,])
...
_THERMALNETWORKINFO = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='backend.db.ThermalNetworkInfo.id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='t_ret_cool', full_name='backend.db.ThermalNetworkInfo.t_ret_cool', index=1,
      number=2, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='t_ret_heat', full_name='backend.db.ThermalNetworkInfo.t_ret_heat', index=2,
      number=3, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='t_ret', full_name='backend.db.ThermalNetworkInfo.t_ret', index=3,
      number=4, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='t_sup', full_name='backend.db.ThermalNetworkInfo.t_sup', index=4,
      number=5, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='t_sup_cool', full_name='backend.db.ThermalNetworkInfo.t_sup_cool', index=5,
      number=6, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='t_sup_heat', full_name='backend.db.ThermalNetworkInfo.t_sup_heat', index=6,
      number=7, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='mflow_central', full_name='backend.db.ThermalNetworkInfo.mflow_central', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='mflow_heating', full_name='backend.db.ThermalNetworkInfo.mflow_heating', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='mflow_cooling', full_name='backend.db.ThermalNetworkInfo.mflow_cooling', index=9,
...
_CONSUMERINFO = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='values', full_name='backend.db.ConsumerInfo.values', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='t_up', full_name='backend.db.ConsumerInfo.t_up', index=2,
      number=3, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_DATAREQUIRED.fields_by_name['block'].enum_type = ict_dot_protobuf_dot_backend_dot_simulation__pb2._SIMULATIONBLOCK
...
DataRequired = _reflection.GeneratedProtocolMessageType('DataRequired', (_message.Message,), dict(
  ...
  __module__ = 'ict.protobuf.backend.db_pb2'
