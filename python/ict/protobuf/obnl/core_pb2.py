...
# source: ict/protobuf/obnl/core.proto
...
SystemInit = _reflection.GeneratedProtocolMessageType('SystemInit', (_message.Message,), dict(
  ...
  __module__ = 'ict.protobuf.obnl.core_pb2'
